...
```
The last command generates json file for predicted results, in the same format as test_new.json in data/intermediate/$DATANAME/rm. Replace the second parameter with whatever threshold you would like.
